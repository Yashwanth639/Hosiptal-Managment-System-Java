...
public class GlobalExceptionHandler {
	...
	// notificationInsertionException
	@ExceptionHandler(NotificationInsertionException.class)
	@ResponseStatus(HttpStatus.NOT_FOUND)
	public ResponseEntity<ResultResponse<Void>> handleNotificationInsertionException(CustomException ex,
			WebRequest request) {
		log.error("Notification Insertion Exception is being thrown : ", ex.getMessage(), ex);
