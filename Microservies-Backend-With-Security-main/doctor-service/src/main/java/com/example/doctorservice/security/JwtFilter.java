...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
    	...
    	// Skip the filter for specific public endpoints
        if (request.getRequestURI().equals("/api/doctors/addDoctor")) {
            System.out.println("Skipping JwtFilter for /api/doctors/addDoctor");
